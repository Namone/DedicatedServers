...
docker image tag $GAME 262580537006.dkr.ecr.us-west-2.amazonaws.com/$GAME-server:10
docker image push 262580537006.dkr.ecr.us-west-2.amazonaws.com/$GAME-server:10
